...
export const ProductCategoryDeleteDialog = (props: IProductCategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bankApp.productProductCategory.delete.question">
        <Translate contentKey="bankApp.productProductCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
