package com.zyllion.sigma.bank.repository;

import com.zyllion.sigma.bank.BankApp;

import com.zyllion.sigma.bank.config.Constants;
import com.zyllion.sigma.bank.config.audit.AuditEventConverter;
import com.zyllion.sigma.bank.domain.PersistentAuditEvent;
...
import static com.zyllion.sigma.bank.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
