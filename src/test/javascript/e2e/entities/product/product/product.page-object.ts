...
export class ProductDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('bankApp.productProduct.delete.question'));
...
export default class ProductComponentsPage {
  ...
  async deleteProduct() {
    ...
    expect(await productDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/bankApp.productProduct.delete.question/);
