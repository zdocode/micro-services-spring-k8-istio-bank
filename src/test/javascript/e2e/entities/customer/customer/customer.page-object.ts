...
export class CustomerDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('bankApp.customerCustomer.delete.question'));
...
export default class CustomerComponentsPage {
  ...
  async deleteCustomer() {
    ...
    expect(await customerDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/bankApp.customerCustomer.delete.question/);
